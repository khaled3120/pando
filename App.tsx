...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Once your deals are verified, your Pandora voucher code will be delivered to your email within 24\u201348 hours."
  }
];
...
export default function App() {
  return (
    <>
      ...
      {/* Top Banner */}
      <div className="w-full bg-[#f4d7d7] text-black text-center py-2 text-[11px] font-bold tracking-widest uppercase">
      ...
      <main className="flex-1 flex flex-col items-center w-full max-w-[400px] mx-auto px-4 pt-6 pb-8">
        ...
        <p className="text-gray-600 text-center mb-6 text-[13px]">
          Claim your <span className="font-bold text-black">$750</span> Pandora voucher
        </p>
        ...
        <div className="w-full flex flex-col gap-2.5 mb-7">
          {STEPS.map((step, index) => (
            ...
            >
              <div className="w-8 h-8 rounded-full bg-black text-white border-[1.5px] border-black flex items-center justify-center font-bold text-[13px] shrink-0 ml-3.5 mr-3.5">
                {index + 1}
              </div>
        ...
        {/* CTA */}
        <button 
           onClick={() => window.location.href = 'https://giftclick.org/aff_c?offer_id=4070&aff_id=144760'}
          className="w-full bg-black hover:bg-gray-800 active:bg-gray-900 transition-colors text-white font-bold text-[15.5px] py-3.5 rounded-full shadow-[0_4px_14px_0_rgba(0,0,0,0.39)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.23)] active:scale-[0.98] text-center block"
        >
          CLAIM NOW
        </button>
